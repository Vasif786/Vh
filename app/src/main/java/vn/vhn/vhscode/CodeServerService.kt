...
class CodeServerService() : Service() {
    companion object {
        ...
        const val BASE_PATH = "/data/data/vn.com.termux"
        ...
        const val ASSET_PREFIX = "/termux_local_asset/"
        ...
        suspend fun loadZipBytes(f: suspend (content: ByteArray?) -> Unit): Unit {
            ...
            try {
                ...
                unloadLibrary("termux-bootstrap")
            }
        }
