...
class NewSessionActivity : AppCompatActivity(), VHEApiModuleHandler {
    companion object {
        ...
        val kCurrentServerVersion = "v4.106.3-" + BuildConfig.CS_VERSION
    ...
    private fun checkLatestVersion() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                val url = URL("https://github.com/vhqtvn/TermuxEditor-Android/releases/latest")
                ...
                val versionExtractor =
                    Regex("\"/vhqtvn/TermuxEditor-Android/releases/tag/v([\\d\\.]+)\"")
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            if (latestRemoteVersion != null) {
                if (latestRemoteVersion == BuildConfig.VERSION_NAME) {
                    ...
                    txtVersion += ", latest version: <a href=\"https://github.com/vhqtvn/TermuxEditor-Android/releases/latest\">${latestRemoteVersion}</a>"
                    txtVersion += " (<a href=\"https://github.com/vhqtvn/TermuxEditor-Android/blob/master/CHANGELOG.md\">ChangeLog</a>)"
                    canAutoRun = false
                }
            }
