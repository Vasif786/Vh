TermuxEditor Android
=================

[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)

![TermuxEditor on Surface Duo 2](https://vhn.vn/images/vheditor.jpg "TermuxEditor on Surface Duo 2")
...
To play with the server, build it yourself using [this repository](https://github.com/vhqtvn/termux-android-server).
